...
./node_modules/.bin/tsx scripts/audit-docs.ts
...
| Skill | Descripción |
|---|---|
| `.claude/skills/commit-report/SKILL.md` | Genera un resumen de avance QA basado en commits, para cualquier rango de fechas — output directo en el chat, sin archivo ni formato de correo |
