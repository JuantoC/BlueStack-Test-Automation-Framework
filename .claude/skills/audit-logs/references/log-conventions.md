# Log Conventions — BlueStack QA Automation

> Convenciones autoritativas del sistema de logs Winston para el framework. Fuente de verdad al ejecutar `audit-logs`.
