...
| High | 2 | Importante, detectado en Dev_SAAS |
| Medium | 3 | Normal (default) |
| Low | 4 | Puede esperar |
...
|-------|---------|------|-------------|
| Componente | `customfield_10061` | array[string] | Tag de componente. No usar para Labels de soporte. |
...
> - `labels` (campo nativo) = se usa para tickets de soporte con tag del cliente (ej. "Martin", "LAURACARVAJAL")
...
| Nombre | Uso QA |
|--------|--------|
| Relates | Vincular ticket Dev_SAAS con ticket original |
