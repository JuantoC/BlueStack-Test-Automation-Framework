...
export function setChromeOptions(options) {
    ...
    '--no-first-run', '--no-default-browser-check', '--disable-extensions', '--disable-default-apps', '--incognito', '--start-maximized', '--force-device-scale-factor=0.8', '--no-sandbox', '--disable-gpu', // Ayuda con errores de Compositor/GL
