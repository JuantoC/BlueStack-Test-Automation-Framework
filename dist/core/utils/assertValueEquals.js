            ...
            if (normalizedActual !== normalizedExpected) {
                ...
                if (diffIndex !== -1) {
                    ...
                    const actCharStr = diffIndex < normalizedActual.length
                        ...
                        : '[Texto extra]';
                    throw new Error(`Valor no coincide para ${locator.toString()}.
...
Obtenido (frag): "...${actualSnippet}..."`);
                ...
                // fallback
                throw new Error(`Valor no coincide para ${locator.toString()}. Longitud ${normalizedExpected.length} vs ${normalizedActual.length}`);
            }
