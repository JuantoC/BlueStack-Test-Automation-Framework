...
export class ImageTable {
  ...
  /**
   * Busca en las primeras 10 imágenes hasta encontrar el título deseado.
   * Retorna el WebElement de la imagen (Container), no del título, para que puedas seguir operando con él.
  */
  ...
  */
  ...
  /**
   * Encuentra el WebElement del contenedor de la imagen basado en su índice.
