---
source: .claude/skills/smart-commit/references/commit-format.md
last-updated: 2026-04-14
---

# Formato de Commits — BlueStack

Convenciones de commits semánticos aplicadas por la skill `smart-commit`.
